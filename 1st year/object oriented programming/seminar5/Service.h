...
public:
	...
	*/
    ...
    void updateSongFromRepository(const std::string& artist, const std::string& title, double minutes, double seconds, const std::string& source, const std::string& artist2, const std::string& title2);
